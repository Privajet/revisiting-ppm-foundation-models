#!/bin/bash
#SBATCH --job-name=llm-peft-ppm_llama32-1b_error_analysis
...
# Configuration
PARAMS_FILE="scripts/llama32-1b_params_error_analysis_selected_params.txt"
PY_MAIN="fertig_lennart_next_event_prediction.py"
PROJECT="llm-peft-ppm_llama32-1b_error_analysis"
